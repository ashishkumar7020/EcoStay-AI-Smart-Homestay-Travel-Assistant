    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 items-center px-4 py-16 sm:px-6 lg:px-8">
        <section className="max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-leaf">Our mission</p>
          <h1 className="mt-4 text-4xl font-bold text-forest sm:text-5xl">About EcoStay AI</h1>
