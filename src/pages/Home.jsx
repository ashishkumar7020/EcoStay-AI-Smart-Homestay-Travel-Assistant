...
const features = [
  ...
  },
  {
    ...
    description: "Track occupancy, monthly bookings, and patterns that help owners plan ahead."
  }
];
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-leaf dark:text-emerald-300">Platform features</p>
            <h2 className="mt-3 text-3xl font-bold text-forest dark:text-emerald-100 sm:text-4xl">Built for better stays and smarter trips</h2>
          </div>
